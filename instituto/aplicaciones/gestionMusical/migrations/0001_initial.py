# Generated by Django 2.2.5 on 2019-09-11 22:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partiturasAsignados', models.ManyToManyField(default=None, to='gestionMusical.Partitura')),
                ...
                ('temasAsignados', models.ManyToManyField(default=None, to='gestionMusical.Tema')),
            ],
            options={
                'verbose_name': 'Clase',
