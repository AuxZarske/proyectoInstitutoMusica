...
from .models import Especialidad, Profesor, Usuario, Alumno, Clase, Partitura, Tema, Compositor, Tutor, MusicaTipo
...
class TutorForm(forms.ModelForm):
    class Meta:
        model = Tutor
        fields = ['nombreTutor','dniTutor','apellidoTutor','tipo']
